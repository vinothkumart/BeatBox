...
import com.vinoth.beatbox.helpers.MediaButtonIntentReceiver;
import com.vinoth.beatbox.helpers.MusicPlaybackTrack;
import com.vinoth.beatbox.lastfmapi.LastFmClient;
import com.vinoth.beatbox.lastfmapi.models.LastfmUserSession;
import com.vinoth.beatbox.lastfmapi.models.ScrobbleQuery;
import com.vinoth.beatbox.permissions.Nammu;
import com.vinoth.beatbox.provider.MusicPlaybackState;
import com.vinoth.beatbox.provider.RecentStore;
import com.vinoth.beatbox.provider.SongPlayCount;
import com.vinoth.beatbox.utils.BeatboxUtils;
import com.vinoth.beatbox.utils.BeatboxUtils.IdType;
import com.vinoth.beatbox.utils.NavigationUtils;
import com.vinoth.beatbox.utils.PreferencesUtility;
...
public class MusicService extends Service {
    public static final String PLAYSTATE_CHANGED = "com.vinoth.beatbox.playstatechanged";
    public static final String POSITION_CHANGED = "com.vinoth.beatbox.positionchanged";
    public static final String META_CHANGED = "com.vinoth.beatbox.metachanged";
    public static final String QUEUE_CHANGED = "com.vinoth.beatbox.queuechanged";
    public static final String PLAYLIST_CHANGED = "com.vinoth.beatbox.playlistchanged";
    public static final String REPEATMODE_CHANGED = "com.vinoth.beatbox.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "com.vinoth.beatbox.shufflemodechanged";
    public static final String TRACK_ERROR = "com.vinoth.beatbox.trackerror";
    public static final String BEATBOX_PACKAGE_NAME = "com.vinoth.beatbox";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "com.vinoth.beatbox.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "com.vinoth.beatbox.togglepause";
    public static final String PAUSE_ACTION = "com.vinoth.beatbox.pause";
    public static final String STOP_ACTION = "com.vinoth.beatbox.stop";
    public static final String PREVIOUS_ACTION = "com.vinoth.beatbox.previous";
    public static final String PREVIOUS_FORCE_ACTION = "com.vinoth.beatbox.previous.force";
    public static final String NEXT_ACTION = "fcom.vinoth.beatbox.next";
    public static final String REPEAT_ACTION = "com.vinoth.beatbox.repeat";
    public static final String SHUFFLE_ACTION = "com.vinoth.beatbox.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "com.vinoth.beatbox.refresh";
    public static final String UPDATE_LOCKSCREEN = "com.vinoth.beatbox.updatelockscreen";
    ...
    public static final String CHANNEL_ID = "beatbox_channel_01";
    ...
    private static final String SHUTDOWN = "com.vinoth.beatbox.shutdown";
    ...
    private void setUpMediaSession() {
        mSession = new MediaSessionCompat(this, "Beatbox");
    ...
    public void onDestroy() {
        ...
        if (BeatboxUtils.isJellyBeanMR2())
    ...
    private void addToPlayList(final long[] list, int position, long sourceId, BeatboxUtils.IdType sourceType) {
    ...
    private void doAutoShuffleUpdate() {
        ...
        for (int i = 0; i < toAdd; i++) {
            ...
            mPlaylist.add(new MusicPlaybackTrack(mAutoShuffleList[idx], -1, BeatboxUtils.IdType.NA, -1));
            notify = true;
        }
        if (notify) {
            notifyChange(QUEUE_CHANGED);
    ...
    private void notifyChange(final String what) {
        ...
        musicIntent.setAction(what.replace(BEATBOX_PACKAGE_NAME, MUSIC_PACKAGE_NAME));
        ...
        if (mRemoteControlClient != null) {
            ...
            if (what.equals(META_CHANGED) || what.equals(QUEUE_CHANGED)) {
                ...
                if (mShowAlbumArtOnLockscreen) {
                    albumArt = ImageLoader.getInstance().loadImageSync(BeatboxUtils.getAlbumArtUri(getAlbumId()).toString());
                    if (albumArt != null) {
    ...
    private void createNotificationChannel() {
        if (BeatboxUtils.isOreo()) {
            CharSequence name = "Beatbox";
    ...
    private Notification buildNotification() {
        ...
        Bitmap artwork;
        artwork = ImageLoader.getInstance().loadImageSync(BeatboxUtils.getAlbumArtUri(getAlbumId()).toString());
        ...
        if (BeatboxUtils.isJellyBeanMR1()) {
        ...
        if (artwork != null && BeatboxUtils.isLollipop()) {
            ...
            if (c != null && c.getCount() != 0) {
                ...
                do {
                    TrackItem t = new TrackItem()
                            .setArt(BeatboxUtils.getAlbumArtUri(c.getLong(c.getColumnIndexOrThrow(AudioColumns.ALBUM_ID))))
                            ...
                            .setDuration(BeatboxUtils.makeShortTimeString(this, c.getInt(c.getColumnIndexOrThrow(AudioColumns.DURATION)) / 1000));
                    list.add(t.get());
                } while (c.moveToNext());
                try {
                ...
                try {
                    if (mCursor != null && shouldAddToPlaylist) {
                        ...
                        mPlaylist.add(new MusicPlaybackTrack(
                                mCursor.getLong(IDCOLIDX), -1, BeatboxUtils.IdType.NA, -1));
                        notifyChange(QUEUE_CHANGED);
                        mPlayPos = 0;
                        mHistory.clear();
                    }
    ...
    public void open(final long[] list, final int position, long sourceId, BeatboxUtils.IdType sourceType) {
        synchronized (this) {
            if (mShuffleMode == SHUFFLE_AUTO) {
...
//            }
    ...
    private static final class ServiceStub extends IBeatboxService.Stub{
