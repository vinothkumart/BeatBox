...
package com.vinoth.beatbox.helpers;
...
public class MusicPlaybackTrack implements Parcelable {
    ...
    public BeatboxUtils.IdType mSourceType;
    public int mSourcePosition;

    public MusicPlaybackTrack(long id, long sourceId, BeatboxUtils.IdType type, int sourcePosition) {
        mId = id;
        mSourceId = sourceId;
        mSourceType = type;
    ...
    public MusicPlaybackTrack(Parcel in) {
        ...
        mSourceType = BeatboxUtils.IdType.getTypeById(in.readInt());
