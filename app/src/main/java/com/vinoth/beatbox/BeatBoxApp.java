...
public class BeatBoxApp extends MultiDexApplication {
    ...
    private static BeatBoxApp mInstance;

    public static synchronized BeatBoxApp getInstance() {
        return mInstance;
    }
    ...
    public void onCreate() {
        ...
        ImageLoaderConfiguration localImageLoaderConfiguration = new ImageLoaderConfiguration.Builder(this).imageDownloader(new BaseImageDownloader(this) {
            PreferencesUtility prefs = PreferencesUtility.getInstance(BeatBoxApp.this);
