...
import static com.vinoth.beatbox.MusicPlayer.mService;
public class BaseActivity extends ATEActivity implements ServiceConnection, MusicStateListener {
    ...
    public void onServiceConnected(final ComponentName name, final IBinder service) {
        mService = IBeatboxService.Stub.asInterface(service);
        onMetaChanged();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (!BeatboxUtils.hasEffectsPanel(BaseActivity.this)) {
