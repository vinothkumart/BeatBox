...
package com.vinoth.beatbox.activities;
...
import com.vinoth.beatbox.cast.ExpandedControlsActivity;
import com.vinoth.beatbox.fragments.AlbumDetailFragment;
import com.vinoth.beatbox.fragments.ArtistDetailFragment;
import com.vinoth.beatbox.fragments.FoldersFragment;
import com.vinoth.beatbox.fragments.MainFragment;
import com.vinoth.beatbox.fragments.PlaylistFragment;
import com.vinoth.beatbox.fragments.QueueFragment;
import com.vinoth.beatbox.permissions.Nammu;
import com.vinoth.beatbox.permissions.PermissionCallback;
import com.vinoth.beatbox.slidinguppanel.SlidingUpPanelLayout;
import com.vinoth.beatbox.subfragments.LyricsFragment;
    ...
    private void checkPermissionAndThenLoad() {
        ...
        if (Nammu.checkPermission(Manifest.permission.READ_EXTERNAL_STORAGE) && Nammu.checkPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            if (Nammu.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Snackbar.make(panelLayout, "beatbox will need to read external storage to display songs on your device.",
