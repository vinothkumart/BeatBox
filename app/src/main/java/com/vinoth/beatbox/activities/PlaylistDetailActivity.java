...
import com.vinoth.beatbox.adapters.SongsListAdapter;
import com.vinoth.beatbox.dataloaders.LastAddedLoader;
...
import com.vinoth.beatbox.dataloaders.TopTracksLoader;
...
import com.vinoth.beatbox.widgets.DragSortRecycler;
...
public class PlaylistDetailActivity extends BaseActivity implements ATEActivityThemeCustomizer, ATEToolbarCustomizer {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (animate && BeatboxUtils.isLollipop()) {
    ...
    private void setAlbumart() {
        ...
        loadBitmap(BeatboxUtils.getAlbumArtUri(getIntent().getExtras().getLong(Constants.ALBUM_ID)).toString());
    }
    ...
    private void clearAutoPlaylists() {
        switch (action) {
            case Constants.NAVIGATE_PLAYLIST_LASTADDED:
                BeatboxUtils.clearLastAdded(this);
                break;
            case Constants.NAVIGATE_PLAYLIST_RECENT:
                BeatboxUtils.clearRecent(this);
                break;
            case Constants.NAVIGATE_PLAYLIST_TOPTRACKS:
                BeatboxUtils.clearTopTracks(this);
                break;
        }
        Intent returnIntent = new Intent();
        setResult(Activity.RESULT_OK, returnIntent);
