...
public class ArtistAdapter extends RecyclerView.Adapter<ArtistAdapter.ItemHolder> implements BubbleTextGetter {
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int i) {
        ...
        String albumNmber = BeatboxUtils.makeLabel(mContext, R.plurals.Nalbums, localItem.albumCount);
        String songCount = BeatboxUtils.makeLabel(mContext, R.plurals.Nsongs, localItem.songCount);
        itemHolder.albums.setText(BeatboxUtils.makeCombinedString(mContext, albumNmber, songCount));
