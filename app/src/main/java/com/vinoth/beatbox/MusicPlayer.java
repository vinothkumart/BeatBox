...
public class MusicPlayer {
    ...
    public static IBeatboxService mService = null;
    ...
    public static void playArtist(final Context context, final long artistId, int position, boolean shuffle) {
        ...
        if (artistList != null) {
            playAll(context, artistList, position, artistId, BeatboxUtils.IdType.Artist, shuffle);
        }
    }
    ...
    public static void playAlbum(final Context context, final long albumId, int position, boolean shuffle) {
        ...
        if (albumList != null) {
            playAll(context, albumList, position, albumId, BeatboxUtils.IdType.Album, shuffle);
        }
    }
    ...
    public static void playNext(Context context, final long[] list, final long sourceId, final BeatboxUtils.IdType sourceType) {
        if (mService == null) {
            return;
        }
        try {
    ...
    public static void shuffleAll(final Context context) {
        ...
        try {
            ...
            mService.open(trackList, -1, -1, BeatboxUtils.IdType.NA.mId);
            mService.play();
            cursor.close();
        } catch (final RemoteException ignored) {
        }
    ...
    public static void addToQueue(final Context context, final long[] list, long sourceId,
                                  BeatboxUtils.IdType sourceType) {
        if (mService == null) {
            return;
        }
        try {
